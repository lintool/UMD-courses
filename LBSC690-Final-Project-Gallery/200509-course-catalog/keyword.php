...
<html>
<head><title>Search by Keyword in a Course Description</title>
...
<?php
echo "<p class=\"style2\">Your search on \"$keyword\" found the following results:</p>";
?>
...
and SectionInformation.CourseID=CourseInformation.CourseID and CourseInformation.CourseDescription LIKE '%$keyword%'"; 
...
odbc_close($conn);
echo "<p class=\"style2\">If you do not see any courses, then your search was unsuccessful.</p>";
?>
