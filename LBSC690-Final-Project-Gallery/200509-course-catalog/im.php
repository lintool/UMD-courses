...
and
SectionInformation.CourseID=CourseInformation.CourseID 
and DepartmentInformation.DepartmentID=1"; 
...
echo "<p class=\"topheader\">CLIS Information Management Courses, Spring 2006</p>";
...
$sql="SELECT CourseName, CourseDescription, CourseNumber, Day, TimeBegin, TimeEnd, Credits, DepartmentName, ProfessorLastName, ProfessorFirstName, SectionName, SectionID, Semester, Location FROM CourseInformation, DepartmentInformation, ProfessorInformation, SectionInformation 
WHERE CourseInformation.DepartmentID=DepartmentInformation.DepartmentID and ProfessorInformation.ProfessorID=SectionInformation.ProfessorID 
