<Html>
<head><title>this is a tests to pull in data from the database</title>
...
echo "<p class=\"topheader\">CLIS Library Science and Information Management Courses, Spring 2006</p>";
