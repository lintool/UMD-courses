...
<?php
echo "<p class=\"style2\">You chose $day. The following classes will be held on $day:";
?>
...
and SectionInformation.CourseID=CourseInformation.CourseID and SectionInformation.Day='$day'"; 
