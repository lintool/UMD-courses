...
<xsl:template match="/">
    <html>
        <head>
            <title>UMD Archives</title>
            <link rel="stylesheet" href="../archives.css"/>
        </head>
        <body style="font-family:Arial, Helvetica, sans-serif">
            <br/>
            <h1 align="center">UMD Archives</h1>
            <xsl:for-each select="archiveslisting/archives">
                ...
                <xsl:choose>
                    <xsl:when test="parentinstitution='University of Maryland'">
                    ...
                    <xsl:when test="parentinstitution='University of Maryland (Baltimore)'">
                        <hr size="1" width="600" align="center"></hr>
                        <table size="600" cellspacing="4" align="center">
                            <tr>
                                <td width="400" valign="top">
                    ...
                    <xsl:when test="parentinstitution='University of Maryland (Baltimore County)'">
                        <hr size="1" width="600" align="center"></hr>
                        <table size="600" cellspacing="4" align="center">
                            <tr>
                                <td width="400" valign="top">
                    ...
                    <xsl:when test="parentinstitution='University of Maryland (College Park) Libraries'">
                        <hr size="1" width="600" align="center"></hr>
                        <table size="600" cellspacing="4" align="center">
                            <tr>
                                <td width="400" valign="top">
