...
<xsl:template match="/">
    <html>
        <head>
            <title>DC Area Archives with Email</title>
            <link rel="stylesheet" href="../archives.css"/>
        </head>
        <body style="font-family:Arial, Helvetica, sans-serif">
            <br/>
            <h1 align="center">DC Area Archives with Email</h1>
            <xsl:if test="archiveslisting/archives[email='NA']"></xsl:if>
            <xsl:otherwise>asdf</xsl:otherwise>
